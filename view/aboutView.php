...
<div class="container aboutStyle">
        <div class='row'>
            <div class="col-md-12">
                <h2>À propos de Jean Forteroche</h2>
            </div>
        </div>
        
        <div class="row">
            <div class="col-md-12">
                <img src="utilitaire/img/jeanforteroche.png" alt="photo de jean forteroche">
            </div>
        </div>
        
        <div class="row">
            <div class="col-md-12">
                <p>Incenderat autem audaces usque ad insaniam homines ad haec, quae nefariis egere conatibus, Luscus quidam curator urbis subito visus: eosque ut heiulans baiolorum praecentor ad expediendum quod orsi sunt incitans vocibus crebris. qui haut longe postea ideo vivus exustus est.<br>
...
$title = 'Jean Forteroche - À propos de Jean Forteroche';
